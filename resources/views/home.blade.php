...
@section('content')
    <div class="container mx-auto">
        <header class="flex flex-col md:flex-row md:justify-between align-middle mt-10 mb-8 p-5">
            ...
            <button class="flex flex-row rounded-full px-8 bg-peachy-pink text-white font-semibold items-center mt-4" @click="$modal.show('create-reminder-modal')">
                ...
                <span class="ml-2 text-xl">New reminder</span>
            </button>
        </header>
