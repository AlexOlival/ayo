...
@section('content')
    <div class="container mx-auto">
        <header class="flex justify-between align-middle mt-10 mb-8 p-5">
        ...
        <section>
            ...
            <section class="flex px-10">
                @foreach([1, 2, 3, 4] as $item)
                    <div class="flex flex-col border-2 border-peachy-pink rounded-lg p-4">
                        <div class="flex justify-between items-center">
                            <p class="mr-8 text-lg">Reminder title</p>
                            <div>
                                <button>
