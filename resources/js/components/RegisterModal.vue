<template>
  <modal height="auto" :adaptive="true" name="register-modal">
    <div class="flex justify-end">
      <img class="p-4" src="/img/ic-close.svg" @click="$modal.hide('register-modal')"/>
    </div>
    <form
    ...
    >
      ...
      <div
        class="text-left text-xs text-grey-dark mb-6"
      >Fill in the form in order to create an account.</div>
